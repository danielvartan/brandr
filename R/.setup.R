...
font_add(
  family = "rubik",
  regular = here("ttf", "rubik-regular.ttf"),
  bold = here("ttf", "rubik-bold.ttf"),
  italic = here("ttf", "rubik-italic.ttf"),
  bolditalic = here("ttf", "rubik-bolditalic.ttf"),
  symbol = NULL
)
...
font_add(
  ...
  regular = here("ttf", "ibmplexmono-regular.ttf"),
  bold = here("ttf", "ibmplexmono-bold.ttf"),
  italic = here("ttf", "ibmplexmono-italic.ttf"),
  bolditalic = here("ttf", "ibmplexmono-bolditalic.ttf"),
  symbol = NULL
)
