...
You can install the released version of `brandr` from [CRAN](https://CRAN.R-project.org) with:
...
- `color_brand_sequential()`, `color_brand_diverging()`, `color_brand_qualitative()`: Sequential, diverging, and qualitative brand color palettes
